...
![](https://img.shields.io/github/repo-size/ShadowEngineTeam/hxluau) ![](https://badgen.net/github/open-issues/ShadowEngineTeam/hxluau) ![](https://badgen.net/badge/license/MIT/green)
...
```bash
haxelib git hxluau https://github.com/ShadowEngineTeam/hxluau.git
```
