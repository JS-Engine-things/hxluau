...
extern class LuaL
{
	...
	/**
	 * Apply sandboxing to the main state (restricts globals).
	 *
	 * @param L The Lua state.
	 */
	@:native('luaL_sandbox')
	...
	/**
	 * Apply sandboxing to a thread state.
	 *
	 * @param L The Lua state (thread).
	 */
	...
	/**
	 * Checks and returns a 64-bit integer argument.
	 * @param L The Lua state.
	 * @param numArg The argument index.
	...
	/**
	 * Returns an optional 64-bit integer argument.
	 * @param L The Lua state.
	 * @param nArg The argument index.
	 * @param def The default 64-bit integer.
	 * @return The 64-bit integer.
	 */
	...
	/**
	 * Checks and returns an unsigned integer argument.
	 * @param L The Lua state.
	 * @param numArg The argument index.
	 ...
	 * @param L The Lua state.
	 * @param numArg The argument index.
	 * @param def The default unsigned integer.
	 * @return The unsigned integer.
	 */
	 ...
	 * @param L The Lua state.
	 * @param narg The argument index.
	 * @param def The default vector pointer.
	 * @return Pointer to 3 (or 4) floats.
	 */
	...
	/**
	 * Calls a function with yieldable C function support.
	 * @param L The Lua state.
	...
	/**
	 * Adds a value from the stack to a buffer at a specific index.
	 * @param B The buffer.
	 * @param idx The stack index of the value to add.
	 */
	@:native('luaL_addvalueany')
	static function addvalueany(B:cpp.RawPointer<LuaL_Buffer>, idx:Int):Void;

	/**
	 * Pushes the result of a buffer to the stack with a given size.
	 * @param B The buffer.
